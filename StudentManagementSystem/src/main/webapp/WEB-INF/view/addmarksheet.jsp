 ...
 <body>
    <%@include file="navbar.jsp" %>
     ...
     <div class="main">
        <div class="container">
        <h1><center>Add Marksheet</center></h1>
        <a href="viewmarksheet"><button class="btn btn-primary"><i class="far fa-eye"></i> View Mark Sheet</button></a>
 <form method="POST" action="viewmarksheet"> 
     <div class="col-md-6"> 
...
<select style="width:80%" id="section" name="sectionsid">
 ...
 <a href="deleteallmarksheet"><button class="btn btn-danger" style="width:200px;">Clear all Marksheet</button></a>
        </div>
    </div>
