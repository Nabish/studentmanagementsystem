...
.calendar{width:100%;font-size:100%;perspective:1000px;cursor:default;position:relative}
...
.tabl{width:100%;font-weight:400;display:table}
.tabl .row{display:table-row}
.tabl .row.head{color:#308ff0;text-transform:uppercase}
.tabl .row .cell{width:14.28%;padding:5px;text-align:center;display:table-cell}
.tabl .row .cell.disable{color:#ccc}
.tabl .row .cell span{display:block;width:28px;height:28px;line-height:28px;transition:color,background .4s ease-in-out 0s}
.tabl .row .cell.active span{color:#fff;background-color:#308ff0}
